...
output_path = "/Users/khushalmodi/Desktop/ASU/Fall_2021/MWDB/Phase-3/Multimedia-and-Web-Databases/Phase3/outputs"

#available reduction techniques
list_reduction_techniques = ["PCA", "SVD", "LDA", "k-means"]

#path to the dict for consistency and avoid redundancy
dict_path = "/Users/khushalmodi/Desktop/ASU/Fall_2021/MWDB/Phase-3/Multimedia-and-Web-Databases/Phase3/file_dict.pkl"

#available classifiers
list_classifiers = ["SVM", "Decision Tree", "PPR"]
...
#available image types
list_image_types_dict = {"cc": 0, "con": 1, "detail": 2, "emboss": 3, "jitter": 4, "neg": 5, "noise01": 6,
                    "noise02": 7, "original": 8, "poster": 9, "rot": 10, "smooth": 11, "stipple": 12}

#available classifiers
classifiers = ["SVD", "Decision-Tree", "PPR-Based"]
